...
public class MemberAction extends ActionSupport implements SessionAware {
	...
	Interest interest_purejava;
	Interest interest_web;
	Interest interest_mobile;
	Interest interest_iot;
	Interest interest_swing;
	Interest interest_jdbc;
	Interest interest_api;
	Interest interest_spring;
	Interest interest_struts;
	Interest interest_etcframework;
	Interest interest_etc;
	
	List<Interest> interestList = new ArrayList<>();
	
	Ability ability_purejava;
	Ability ability_web;
	Ability ability_mobile;
	Ability ability_iot;
	Ability ability_swing;
	Ability ability_jdbc;
	Ability ability_api;
	Ability ability_spring;
	Ability ability_struts;
	Ability ability_etcframework;
	Ability ability_etc;
	...
	public String insertMember() {
		...
		System.out.println(member_jt+"멤버 등록!");

		dao.insertMember(member_jt);
		
		System.out.println("흥미도 시작");
	    ...
	    for(int i = 0; i < interestList.size(); i++){
	    	...
	    	System.out.println("실험:"+interestList.get(i));
	    }
	    ...
	    for(int i = 0; i < abilityList.size(); i++){
	    	...
	    	System.out.println("실험:"+abilityList.get(i));
	    }
